...
def create_item_from_search_term(database_record):
    # Create lowest_uri
    lowest_uri = URICreator.create_uri(database_record.return_search_term(), "L")
    ...
    # Create sold_uri
    sold_uri = URICreator.create_uri(database_record.return_search_term(), "S")
    ...
    item = Item(database_record.return_search_term(), lowest_uri, sold_uri, lowest_listing_list, sold_listing_list, '', 0, 0, 0, 0, 0, 0, database_record)
